...
describe('SmartScore', () => {
  ...
  it('deve exibir mensagem de threshold quando smartScore é null', () => {
    ...
    expect(screen.getByText('Score Inteligente disponível após 3 avaliações')).toBeInTheDocument();
  ...
  it('deve ter aria-labels acessíveis nos valores', () => {
    ...
    expect(screen.getByLabelText('Score inteligente: 6.3 de 10')).toBeInTheDocument();
    expect(screen.getByLabelText('Média simples: 3.5 de 5')).toBeInTheDocument();
  });
